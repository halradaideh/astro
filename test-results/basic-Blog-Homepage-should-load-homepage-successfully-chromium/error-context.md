...
- Name: Blog Homepage >> should load homepage successfully
- Location: /Users/hamdanradaideh/pale-parsec/tests/e2e/basic.spec.ts:4:3

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('nav a[href="/"]') resolved to 2 elements:
    ...
    2) <a href="/" class="nav-link active" data-astro-cid-pux6a34n="" data-astro-source-loc="13:79" data-astro-source-file="/Users/hamdanradaideh/pale-parsec/src/components/Navigation.astro">Home</a> aka getByRole('link', { name: 'Home' })

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('nav a[href="/"]')

    at /Users/hamdanradaideh/pale-parsec/tests/e2e/basic.spec.ts:10:51
```
