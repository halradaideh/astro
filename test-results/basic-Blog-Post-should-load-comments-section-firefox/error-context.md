...
- Name: Blog Post >> should load comments section
- Location: /Users/hamdanradaideh/sourcegit/astro/tests/e2e/basic.spec.ts:65:3

# Error details

```
Error: page.goto: Protocol error (Page.navigate): Invalid url: "/blog"
Call log:
  - navigating to "/blog", waiting until "load"

    at /Users/hamdanradaideh/sourcegit/astro/tests/e2e/basic.spec.ts:66:16
```
