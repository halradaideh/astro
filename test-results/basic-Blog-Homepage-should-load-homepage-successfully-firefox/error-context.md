...
Error: expect.toBeVisible: Error: strict mode violation: locator('nav a[href="/"]') resolved to 2 elements:
    1) <a href="/" data-astro-cid-pux6a34n="">Hamdan Radaideh</a> aka getByRole('link', { name: 'Hamdan Radaideh' })
    2) <a href="/" class="nav-link active" data-astro-cid-pux6a34n="">Home</a> aka getByRole('link', { name: 'Home' })
